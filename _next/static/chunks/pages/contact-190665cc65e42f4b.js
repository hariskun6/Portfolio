    ...
    4451: function (e, t, n) {
      ...
      var N = (0, h.memo)(function (e) {
        var t = e.text,
          ...
          g = void 0 === p ? 0 : p,
          N = e.className,
          w = (0, i.Z)(e, ["text", "start", "delay", "className"]),
          b = (0, h.useRef)([{ type: y, value: "" }]),
          C = (0, h.useRef)(),
          S = (0, d.J)(),
        ...
        return (
          (0, h.useEffect)(
            function () {
              var e = C.current,
                n = t.split(""),
                a = function () {
                  var t = b.current.map(function (e) {
                    return '<span class="'
                      .concat(_()[e.type], '">')
                      .concat(e.value, "</span>");
                  });
          ...
          (0, l.jsxs)(
            "span",
            (0, o.Z)((0, a.Z)({ className: (0, v.Sh)(_().text, N) }, w), {
              children: [
        ...
        C = function (e) {
          ...
          return (0, s.jsxs)(
            ...
            (0, f.Z)(
              (0, a.Z)(
                {
                  className: (0, x.Sh)(j().container, i),
                  "data-error": !!l,
                  style: c,
                },
                C
                ...
                return n
                  ...
                  : (d.current && d.current.stop(),
                    (d.current = (0, o.j)(
                      (0, r.pi)(
                        (0, r.pi)(
                          { from: m.get(), to: e, velocity: m.getVelocity() },
                          t
                        ),
                        { onUpdate: a }
                      )
